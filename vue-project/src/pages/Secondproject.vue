...
<template>
    <body>
        ...
        <h1 class="text-center mb-2"><span class="spotytitle">SPOTIFY</span>  WEBSITE REMAKE</h1>
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div id="carouselExampleControls" class="carousel slide col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 p-3" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/boolifyPC.png"
                            class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/boolfypchover.png"
                            class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="/boolifyhover2pc.png"
                            class="d-block w-100" alt="...">
                    </div>
                </div>
            ...
            <div class="col-10 text-center p-1">
                    ...
                    <p>Esso consiste nel ricreare,in ogni minimo dettaglio,la parte estetica della web app di Spotify,un servizio musicale non-libero svedese che offre lo streaming on demand di una selezione di brani di varie case discografiche ed etichette indipendenti, incluse Sony, EMI, Warner Music Group e Universal.</p>
